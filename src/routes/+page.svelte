<script>
  ...
  <p class="text-center mt-6 text-gray-500">Due to YouTube's new ad blocking updates, all code must noe be run locally
    for it to work.
  </p>
  <p class="text-center mt-6 text-gray-500">A link to instructions and the code can be found <a class="underline text-blue-600 hover:text-blue-800 visited:text-purple-600" href="https://github.com/danielxoates/yt_downloader">here</a></p>
